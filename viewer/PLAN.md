...
viewer/
  ...
  scripts/phone-omni.mjs    `npm run phone`: adb-forwards Chrome DevTools on the USB Samsung and prints __omni plus a SAMSUNG.md benchmark row
...
| 13:00 | masked scene with `floor_y`; QA slider values per device | A, C | deployed URL and QR text (delivered 2026-09-19: Pages live, `public/qr.png`), `__omni` numbers for the pitch |
